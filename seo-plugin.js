...
function buildJsonLd(globalInfo, projects, studio, awards, faqList) {
    ...
    const person = {
        ...
        name: 'Kashaf Zahra',
        alternateName: ['Kashaf Zahra', 'Kashaf', 'CS Student'],
        url: 'https://www.linkedin.com/in/kashaf-zahra-531728385/',
        jobTitle: 'CS Student & Web Developer',
        description: globalInfo?.aboutMe || 'CS student specializing in 3D web experiences and interactive frontend development.',
    ...
    const website = {
        ...
        name: globalInfo?.siteTitle || 'Kashaf Zahra | CS Student Portfolio',
        description: globalInfo?.siteDescription || 'Interactive 3D Developer Portfolio by Kashaf Zahra',
